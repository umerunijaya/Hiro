                                ...
                                <div class="px-3">
                                    <div class="auth-logo-box">
                                        <a href="../dashboard/analytics-index.html" class="logo logo-admin">
                                            <img src="<?php echo e(asset('public/admin/assets/images/logo-sm.png')); ?>" height="55" alt="logo" class="auth-logo"></a>
                                    ...
                                    <?php if(!empty(session('errormsg'))): ?> <?php echo e(session('errormsg')); ?> <?php endif; ?>
                                    <form class="form-horizontal auth-form my-4" action="<?php echo e(url('/admin/dologin')); ?>" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" value="<?php echo e(old('email')); ?>" class="form-control" name="email" id="username" placeholder="Enter email">
                                            <small><?php if(!empty($errors->first('email'))): ?> <?php echo e($errors->first('email')); ?> <?php endif; ?></small>   
                                        </div>                                    
                                        </div><!--end form-group--> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3"> 
                                                ...
                                                <small><?php if(!empty($errors->first('password'))): ?> <?php echo e($errors->first('password')); ?> <?php endif; ?></small> 
                                            </div>                               
                                        </div><!--end form-group--> 
...
</html><?php /**PATH C:\xampp\htdocs\moveklang\resources\views/admin/pages/login.blade.php ENDPATH**/ ?>
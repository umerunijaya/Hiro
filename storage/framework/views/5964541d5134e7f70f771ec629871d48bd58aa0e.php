...
<link href="<?php echo e(asset('public/admin/plugins/jvectormap/jquery-jvectormap-2.0.2.css')); ?>" rel="stylesheet">
                    ...
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class=" d-flex justify-content-between">
                                        <img src="<?php echo e(asset('public/admin/assets/images/widgets/monthly-re.png')); ?>" alt="" height="75">
                        ...
                        <div class="col-xl-9">
                            <div class="card">
                                <div class="card-body">
                                    <div class="media">
                                        <img src="<?php echo e(asset('public/admin/assets/images/users/user-1.png')); ?>" alt="" class="thumb-md rounded-circle mr-2">                                       
                                    ...
                                    <div class="welcome-img">
                                        <img src="<?php echo e(asset('public/admin/assets/images/widgets/w-2.svg')); ?>" alt="" height="120" class="mt-n4 mr-5 d-none d-lg-block">    
                                    </div>                                       
                                </div><!--end card-body--> 
                            </div><!--end card-->
                            <div class="row">
                                    ...
                                    <div id="carousel_2" class="carousel slide" data-ride="carousel">
                                        <div class="carousel-inner">
                                            ...
                                            <div class="carousel-item">
                                                <div class="media">
                                                    <img src="<?php echo e(asset('public/admin/assets/images/users/user-2.jpg')); ?>" class="mr-2 thumb-lg rounded-circle" alt="...">
                                                    <div class="media-body align-self-center">                                                           
                                            ...
                                            <div class="carousel-item">
                                                <div class="media">
                                                    <img src="<?php echo e(asset('public/admin/assets/images/users/user-3.jpg')); ?>"  class="mr-2 thumb-lg rounded-circle" alt="...">
                                                    <div class="media-body align-self-center">                                                          
                                    ...
                                    <div class="bg-light p-3 mt-3 d-flex justify-content-between">
                                        ...
                                        <div class="img-group align-self-center">
                                            <a class="user-avatar user-avatar-group" href="#">
                                                <img src="<?php echo e(asset('public/admin/assets/images/users/user-6.jpg')); ?>" alt="user" class="rounded-circle thumb-xs">
                                            </a>
                                            <a class="user-avatar user-avatar-group" href="#">
                                                <img src="<?php echo e(asset('public/admin/assets/images/users/user-2.jpg')); ?>" alt="user" class="rounded-circle thumb-xs">
                                            </a>
                                            <a class="user-avatar user-avatar-group" href="#">
                                                <img src="<?php echo e(asset('public/admin/assets/images/users/user-3.jpg')); ?>" alt="user" class="rounded-circle thumb-xs">
                                            </a>
                                            <a class="user-avatar user-avatar-group" href="#">
                                                <img src="<?php echo e(asset('public/admin/assets/images/users/user-4.jpg')); ?>" alt="user" class="rounded-circle thumb-xs">
                                            </a>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><img src="<?php echo e(asset('public/admin/assets/images/users/user-10.jpg')); ?>" alt="" class="thumb-sm rounded-circle mr-2">Donald Gardner</td>
                                                    <td>xyx@gmail.com</td>
                                                    <td>+123456789</td>
                                                ...
                                                <tr>
                                                    <td><img src="<?php echo e(asset('public/admin/assets/images/users/user-9.jpg')); ?>" alt="" class="thumb-sm rounded-circle mr-2">Matt Rosales</td>
                                                    <td>xyx@gmail.com</td>
                                                    <td>+123456789</td>
                                                    <td>Mac Donald</td>
                                                    <td> <span class="badge badge-md badge-soft-purple">New Lead</span></td>
                                                ...
                                                <tr>
                                                    <td><img src="<?php echo e(asset('public/admin/assets/images/users/user-8.jpg')); ?>" alt="" class="thumb-sm rounded-circle mr-2">Michael Hill</td>
                                                    <td>xyx@gmail.com</td>
                                                    <td>+123456789</td>
                                                    <td>Life Good</td>
                                                ...
                                                <tr>
                                                    <td><img src="<?php echo e(asset('public/admin/assets/images/users/user-7.jpg')); ?>" alt="" class="thumb-sm rounded-circle mr-2">Nancy Flanary</td>
                                                    <td>xyx@gmail.com</td>
                                                    <td>+123456789</td>
                                                    <td>Flipcart</td>
                                                    <td> <span class="badge badge-md badge-soft-purple">New Lead</span></td>
                                                ...
                                                <tr>
                                                    <td><img src="<?php echo e(asset('public/admin/assets/images/users/user-6.jpg')); ?>" alt="" class="thumb-sm rounded-circle mr-2">Dorothy Key</td>
                                                    <td>xyx@gmail.com</td>
                                                    <td>+123456789</td>
                                                    <td>Adidas</td>
                                                ...
                                                <tr>
                                                    <td><img src="<?php echo e(asset('public/admin/assets/images/users/user-5.jpg')); ?>" alt="" class="thumb-sm rounded-circle mr-2">Joseph Cross</td>
                                                    <td>xyx@gmail.com</td>
                                                    <td>+123456789</td>
                                                    <td>Reebok</td>
...
<?php $__env->startPush('js'); ?>
     ...
     <script src="<?php echo e(asset('public/admin/plugins/apexcharts/apexcharts.min.js')); ?>"></script>
     <script src="<?php echo e(asset('public/admin/plugins/jvectormap/jquery-jvectormap-2.0.2.min.js')); ?>"></script>
     <script src="<?php echo e(asset('public/admin/plugins/jvectormap/jquery-jvectormap-world-mill-en.js')); ?>"></script>
     <script src="<?php echo e(asset('public/admin/plugins/flot-chart/jquery.canvaswrapper.js')); ?>"></script>
     <script src="<?php echo e(asset('public/admin/plugins/flot-chart/jquery.colorhelpers.js')); ?>"></script>
     <script src="<?php echo e(asset('public/admin/plugins/flot-chart/jquery.flot.js')); ?>"></script>        
     <script src="<?php echo e(asset('public/admin/plugins/flot-chart/jquery.flot.saturated.js')); ?>"></script>
     <script src="<?php echo e(asset('public/admin/plugins/flot-chart/jquery.flot.browser.js')); ?>"></script>
     <script src="<?php echo e(asset('public/admin/plugins/flot-chart/jquery.flot.drawSeries.js')); ?>"></script> 
     <script src="<?php echo e(asset('public/admin/plugins/flot-chart/jquery.flot.uiConstants.js')); ?>"></script>
     <script src="<?php echo e(asset('public/admin/plugins/flot-chart/jquery.flot-dataType.js')); ?>"></script>
     <script src="<?php echo e(asset('public/admin/assets/pages/jquery.crm_dashboard.init.js')); ?>"></script>

     <!-- App js -->
     <script src="<?php echo e(asset('public/admin/assets/js/app.js')); ?>"></script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\moveklang\resources\views/admin/pages/dashboard.blade.php ENDPATH**/ ?>
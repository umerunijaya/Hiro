<?php $__env->startSection('title', 'Move Klang | Best Business Promotion Platform'); ?>
					...
					<div id="home-slider">
						...
						<div class="post feature-post">
							<div class="entry-header">
								...
								<img class="img-responsive" src="<?php echo e(asset('public/assets/images/sliders/')); ?>/<?php echo e($slider->image); ?>" alt="" />
								</div>
							</div>
						</div><!--/post-->
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\moveklang\resources\views/frontend/pages/homepage.blade.php ENDPATH**/ ?>